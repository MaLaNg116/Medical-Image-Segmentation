...
def train_level3(freeze):
    ...
    # 通过 DataLoader 加载数据
    train_dataset = ImageDataset(args.data_root, "TrainDataset")
    val_dataset = ImageDataset(args.data_root, "ValDataset")
...
def get_parser():
    ...
    parser.add_argument('--data-root', default="data/polyp", required=False, help='path to dataset')
    parser.add_argument('--batch-size', type=int, default=16, help='input batch size')
    parser.add_argument('--niter', type=int, default=100, help='number of epochs to train for')
    parser.add_argument('--lr', type=float, default=1e-4, help='learning rate, default=0.0001')
    parser.add_argument('--model-save', default='./models/new8_model.pth', help='folder to output model checkpoints')
    parser.add_argument('--model-path', default='./models/new8_model.pth',
